...
if xcrun altool --upload-app --type ios -f $path -u a.alaa@cryptydgames.com -p eqcj-eavm-jbtj-gcfr ; then
    ...
    watchbuild -a com.cryptyd.balootQuest2 -u m.hesham@cryptydgames.com --slack_url https://hooks.slack.com/services/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
else
